#!/usr/bin/env python3
"""
Mail Room program enhanced to use dictionary data structure to hold donor info.
Dictionary is also used for the main menu logic. Additionally, if the user
chooses an option to thank all donors, multiple files are generated - one for
each donor with the file name being the donor name and written to the disk.
